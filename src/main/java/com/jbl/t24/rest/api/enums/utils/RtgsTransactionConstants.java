...
public class RtgsTransactionConstants {
	...
	static {
		...
		rtgsConstants.put("FC_08_IN_CAD", ConstantValues.builder().transactionType("ACRI").code(8507).build());
		...
		rtgsConstants.put("FC_09_OUT_CAD", ConstantValues.builder().transactionType("ACOP").code(9007).build());
		...
		rtgsConstants.put("FC_09_IN_CAD", ConstantValues.builder().transactionType("ACIN").code(9507).build());
		...
		rtgsConstants.put("FC_09_OUT_USD_S", ConstantValues.builder().transactionType("ACNO").code(6903).build());
		rtgsConstants.put("FC_09_OUT_EUR_S", ConstantValues.builder().transactionType("ACNO").code(6904).build());
		rtgsConstants.put("FC_09_OUT_GBP_S", ConstantValues.builder().transactionType("ACNO").code(6905).build());
		rtgsConstants.put("FC_09_OUT_JPY_S", ConstantValues.builder().transactionType("ACNO").code(6906).build());
		rtgsConstants.put("FC_09_OUT_CAD_S", ConstantValues.builder().transactionType("ACNO").code(6907).build());

		//rtgsConstants.put("BDT_09_IN_S", ConstantValues.builder().transactionType("ACIS").code(7901).build());
		rtgsConstants.put("FC_09_IN_USD_S", ConstantValues.builder().transactionType("ACNI").code(7903).build());
		rtgsConstants.put("FC_09_IN_EUR_S", ConstantValues.builder().transactionType("ACNI").code(7904).build());
		rtgsConstants.put("FC_09_IN_GBP_S", ConstantValues.builder().transactionType("ACNI").code(7905).build());
