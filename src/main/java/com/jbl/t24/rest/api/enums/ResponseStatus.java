...
public enum ResponseStatus {
	...
	FOURZ7(407, "Credit A/C number mismatch or not found!"), FOURZ8(408, "Credit A/C number can't be empty!"),
	FOURZ9(409, "Length Does Not Match!"), FOURZ10(410, "Cover A/C number missing or not found!"),
	FOURZ11(411, "Cover A/C Branch Code Not Match!"), FOURZ12(412, "Account Length Does Not Match!"),
	FOURZ13(413, "Account Number is Not Active!"), FOURZ14(414, "Cover Account Does Not Have Minimum Balance!"),
