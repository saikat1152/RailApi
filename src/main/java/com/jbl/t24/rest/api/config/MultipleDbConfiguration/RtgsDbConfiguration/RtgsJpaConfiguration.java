...
@EnableJpaRepositories(basePackages = "com.jbl.t24.rest.api.repository.rtgs", entityManagerFactoryRef = "rtgsEntityManagerFactory", repositoryFactoryBeanClass = EnversRevisionRepositoryFactoryBean.class, transactionManagerRef = "rtgsTransactionManager")
public class RtgsJpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean rtgsEntityManagerFactory(
			@Qualifier("rtgsDataSource") DataSource dataSource, EntityManagerFactoryBuilder builder) {
		HashMap<String, Object> properties = new HashMap<String, Object>();
		// properties.put("hibernate.hbm2ddl.auto", "update");
		properties.put("hibernate.listeners.envers.rev_entity", "com.jbl.audit.AuditRevisionEntity");
		return builder
				.dataSource(dataSource).properties(properties).packages("com.jbl.t24.rest.api.model.rtgs",
						"com.jbl.t24.rest.api.audit", "com.jbl.t24.rest.api.model.ApiLogs")
				.persistenceUnit("rtgs").build();
	}
