...
public class RtgsOutwardTransaction {
	...
	@Autowired
	private RtgsHandlerService rtgsHandlerService;
	...
	public ResponseEntity<?> beftnTrasferInward(@Valid @RequestBody RtgsInfoOutward rtgsInfoOut,
			HttpServletRequest httpServletRequest) throws Exception {
		...
		ResponseEntity<?> response = rtgsHandlerService.handleRtgsTransaction(requestOFS, rtgsInfoOut, httpServletRequest);
