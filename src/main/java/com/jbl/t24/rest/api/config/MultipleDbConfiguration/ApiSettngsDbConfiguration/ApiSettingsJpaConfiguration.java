...
@EnableJpaRepositories(basePackages = "com.jbl.t24.rest.api.repository.base", entityManagerFactoryRef = "baseEntityManagerFactory", repositoryFactoryBeanClass = EnversRevisionRepositoryFactoryBean.class, transactionManagerRef = "baseTransactionManager")
public class ApiSettingsJpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean baseEntityManagerFactory(
			@Qualifier("baseDataSource") DataSource dataSource, EntityManagerFactoryBuilder builder) {
		HashMap<String, Object> properties = new HashMap<String, Object>();
		// properties.put("hibernate.hbm2ddl.auto", "update");
		properties.put("hibernate.listeners.envers.rev_entity", "com.jbl.audit.AuditRevisionEntity");
		return builder.dataSource(dataSource).properties(properties)
				.packages("com.jbl.t24.rest.api.model.base", "com.jbl.t24.rest.api.audit").persistenceUnit("base")
				.build();
	}
